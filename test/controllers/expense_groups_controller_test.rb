...
class ExpenseGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create expense_group' do
    assert_difference('ExpenseGroup.count') do
      post expense_groups_url,
           params: { expense_group: { amount: @expense_group.amount, expense_id: @expense_group.expense_id,
                                      group_id: @expense_group.group_id } }
    end
  ...
  test 'should update expense_group' do
    patch expense_group_url(@expense_group),
          params: { expense_group: { amount: @expense_group.amount, expense_id: @expense_group.expense_id,
                                     group_id: @expense_group.group_id } }
